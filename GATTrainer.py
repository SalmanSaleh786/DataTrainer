...
# ================================
# 4. Define a Graph Attention Network
# ================================
...
model = GAT(input_dim, hidden_dim, output_dim, heads=4).to(device)
...
torch.save(model.state_dict(), "GAT_swarm_model.pt")
print("✅ Training complete. Model saved as GAT_swarm_model.pt")
