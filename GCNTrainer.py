...
for epoch in range(1, 51):
    ...
    with torch.no_grad():
        for batch in test_loader:
            ...
            total_graphs += batch.num_graphs  # count graphs in the batch
...
torch.save(model.state_dict(), "GCN_swarm_model.pt")
print("✅ Training complete. Model saved as GCN_swarm_model.pt")
