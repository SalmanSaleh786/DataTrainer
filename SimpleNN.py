...
import random
import time  # <== ADD THIS NEAR THE TOP
...
# ===================================================
# 2. Split 80/20 for training and testing  # === NEW ===
# ===================================================
...
# ================================
# 3. Define a simple Feedforward NN (MLP) with BatchNorm + Dropout
# ================================
...
model = SimpleNN(input_dim, hidden_dim, output_dim, dropout=0.3).to(device)
...
torch.save(model.state_dict(), "SimpleNN_swarm_model.pt")
print("✅ Training complete. Model saved as SimpleNN_swarm_model.pt")